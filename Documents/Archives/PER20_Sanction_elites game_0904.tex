...
\begin{itemize}
	...
	\item $\delta$ is the amount of cost for \textit{E} when they give up through conceding to \textit{M} (democratization costs for \textit{E}). In other words, $\delta$ is the amount of benefit for \textit{M} can get when \text{E} gives something up during democratization. \textcolor{red}{I assume $\delta$ is always positive, which means democracy is always good for masses.}
\end{itemize}
