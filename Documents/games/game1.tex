	...
	\istb{Agree}[above,sloped]{\textit{Resistance Game} $(E- \alpha_{E}$, $M-\alpha_{E})$ }
	\istb{$\sim$Agree}[above,sloped]{ }  \endist
	\istroot(3)(1-2)<180>{\textbf{Masses}}+20mm..25mm+
	\istb{$\alpha_{M}$}[above,sloped]{\textit{Accountability Game with $\alpha_{E}$ }
		$(E- \alpha_{E}- \beta_{E}$, $M-\alpha_{E}-\beta_{M})$}
	\istb{$\sim\alpha_{M}$}[above,sloped]{\textit{Accountability Game $\sim\alpha_{E}$} 
		$(E- \beta_{E}$, M$-\beta_{M})$} \endist
	\istroot(2)(0-2)<180>{\textbf{Masses}}+20mm..25mm+
	\istb{$\sim$Agree}[above,sloped]{\textit{Revolt Game} $(E - \beta_{E},\; M-\beta_{M})$}
